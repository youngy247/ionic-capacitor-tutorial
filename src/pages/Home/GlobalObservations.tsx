...
import CardModal from "./GuideModal";
    ...
    <IonPage ref={page}>
      ...
      <IonContent className="ion-padding">
        <div className="component-wrapper">
          ...
          <CardModal isOpen={showCardModal} handleDismiss={handleCardModalDismiss} />
          <IonFab
            ...
            slot="fixed"
          >
            <IonFabButton onClick={() => setShowCardModal(true)}>
